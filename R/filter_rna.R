...
data_mean_cutoff <- args[3] # mean cutoff (empirically derived below)
...
data_nonzero <- data_nomedia[rowSums(data_nomedia[, -1])>0, ] # remove zeros
...
write.table(data_expressed, file=gzfile(out_file), quote=FALSE)
